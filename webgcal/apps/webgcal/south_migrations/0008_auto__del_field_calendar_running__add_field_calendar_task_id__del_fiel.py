...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Calendar.running'
        db.delete_column(u'webgcal_calendar', 'running')
        ...
        # Deleting field 'Website.running'
        db.delete_column(u'webgcal_website', 'running')
    ...
    def backwards(self, orm):
        # Adding field 'Calendar.running'
        db.add_column(u'webgcal_calendar', 'running',
        ...
        # Adding field 'Website.running'
        db.add_column(u'webgcal_website', 'running',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
