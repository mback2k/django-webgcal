...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Calendar.feed'
        db.delete_column('webgcal_calendar', 'feed')

        # Deleting field 'Calendar.href'
        db.delete_column('webgcal_calendar', 'href')

        # Deleting field 'Event.href'
        db.delete_column('webgcal_event', 'href')


    def backwards(self, orm):
        # Adding field 'Calendar.feed'
        db.add_column('webgcal_calendar', 'feed',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Calendar.href'
        db.add_column('webgcal_calendar', 'href',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Event.href'
        db.add_column('webgcal_event', 'href',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)
