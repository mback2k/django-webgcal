...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Calendar.google_id'
        db.alter_column('webgcal_calendar', 'google_id', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Event.google_id'
        db.alter_column('webgcal_event', 'google_id', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Calendar.google_id'
        db.alter_column('webgcal_calendar', 'google_id', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Event.google_id'
        db.alter_column('webgcal_event', 'google_id', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
