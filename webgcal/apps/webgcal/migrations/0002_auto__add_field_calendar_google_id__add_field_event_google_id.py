...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Calendar.google_id'
        db.add_column('webgcal_calendar', 'google_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Event.google_id'
        db.add_column('webgcal_event', 'google_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Calendar.google_id'
        db.delete_column('webgcal_calendar', 'google_id')

        # Deleting field 'Event.google_id'
        db.delete_column('webgcal_event', 'google_id')
